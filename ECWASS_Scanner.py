...
def _finding(ecwass_id, title, severity, url, detail):
...
class BurpExtender(IBurpExtender, IScannerCheck, ITab,
    ...
    def _buildFindingsPanel(self):
        ...
        tb.add(JLabel("  ECWASS Security Scanner  "))
        tb.addSeparator()
    ...
    def _applyFilter(self):
        ...
        if txt:
            try: self._sorter.setRowFilter(RowFilter.regexFilter("(?i)" + txt))
